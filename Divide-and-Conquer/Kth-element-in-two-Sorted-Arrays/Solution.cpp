...
/*
Name        : kthElement()
Description : Computes the kth element of two sorted arrays
Arguments   : The two arrays and three integers denoting the sizes of first and second array and the required index (1-indexed), in that order
Return      : An integer denoting the kth element (1-indexed) of the combined sorted array
*/
int kthElement(int arr1[], int arr2[], int m, int n, int k) {
    ...
    int total = m + n, left = k;
    int low = max(0, k - n), high = min(k, n), mid1, mid2, left1, right1, left2, right2, result;
    ...
    while(low <= high) {
        ...
        // Check for valid left and right half and compute the kth element
