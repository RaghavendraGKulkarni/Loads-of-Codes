...
/*
Name        : find()
Description : Computes the floor value of a key in a binary search tree, recursively
Arguments   : The pointer to the root node of the tree, the key and a double pointer to store the floor value node, in that order
Return      : None
*/
...
int main() {
    ...
    TreeNode* result = recursiveFindFloor(root, key);
