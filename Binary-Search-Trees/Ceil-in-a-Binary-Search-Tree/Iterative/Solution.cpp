...
/*
Name        : iterativeFindCeil()
Description : Computes the ceil value of a key in a binary search tree, iteratively
Arguments   : The pointer to the root node of the tree and the key, in that order
Return      : The pointer to the ceil value node
*/
TreeNode* iterativeFindCeil(TreeNode* root, int key) {
...
int main() {
    ...
    TreeNode* result = iterativeFindCeil(root, key);
