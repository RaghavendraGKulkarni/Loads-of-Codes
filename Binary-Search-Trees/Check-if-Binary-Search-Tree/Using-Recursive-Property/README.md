...
## Description:
### Given a binary tree of n nodes, the program checks whether the tree is a valid Binary Search Tree using Recursive Property
## Input Format:
...
## Output Format:
* The first and only output line will contain "Yes" if the tree is a Binary Search Tree and "No" otherwise
## Time Complexity: 
* O(n)
## Space Complexity: 
* O(n)