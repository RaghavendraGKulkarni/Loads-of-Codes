...
ListNode* sortTernaryList(ListNode *head) {
    ...
    ListNode *h0 = NULL, *t0 = NULL, *h1 = NULL, *t1 = NULL, *h2 = NULL, *t2 = NULL, *t;
    ...
    // Arrange the three segregated sub-lists according to the order
    head = NULL;
    if(t0) {
        head = h0;
        if(h1)
...
int main() {
    ...
    // Call the subroutine to sort the ternary linked list
    head = sortTernaryList(head);
