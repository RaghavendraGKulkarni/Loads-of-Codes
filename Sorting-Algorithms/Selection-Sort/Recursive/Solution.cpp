...
/*
Name        : recursiveSelectionSort()
Description : Sorts the array using Selection Sort recursively
Arguments   : The array to be sorted and the right ending index of the array, in that order
Return      : None
*/
void recursiveSelectionSort(int arr[], int n) {
    ...
    // Recursively call for the left subarray
