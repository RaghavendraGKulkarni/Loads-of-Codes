...
## Description:
### Given a binary tree of n nodes, the program prints the Top View of the Binary Tree from left to right
## Input Format:
...
## Output Format:
* The first and only output line will contain space separated integers denoting the top view of the binary tree
## Time Complexity: 
* O(n)
## Space Complexity: 
* O(n)