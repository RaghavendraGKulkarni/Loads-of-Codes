# Preorder Traversal
## Description:
### Given a binary tree of n nodes, the program prints the Preorder Traversal of the Binary Tree recursively
## Input Format:
...
## Output Format:
* The first and only output line will contain space separated integers denoting the preorder traversal
## Time Complexity: 
* O(n)
## Space Complexity: 
* O(n)