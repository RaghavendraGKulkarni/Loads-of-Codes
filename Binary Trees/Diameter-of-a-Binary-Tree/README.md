...
## Description:
### Given a binary tree of n nodes, the program finds the diameter of the binary tree
## Input Format:
...
## Output Format:
* The first and the only line will contain an integer denoting the diameter of the tree
## Time Complexity: 
* O(n)
## Space Complexity: 
* O(n)