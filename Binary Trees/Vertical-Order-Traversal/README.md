...
## Description:
### Given a binary tree of n nodes, the program prints the Vertical Order Traversal of the Binary Tree from left to right and top to bottom
## Input Format:
...
## Output Format:
* The first and only output line will contain space separated integers denoting the vertical order traversal
## Time Complexity: 
* O(n)
## Space Complexity: 
* O(n)